import type { APIPaths, APIRequests, APIResponse } from "./export/ign-geocodage";

const baseURL = "https://petstore3.swagger.io/api/v3";

export async function fetchAPI<Path extends APIPaths, Options extends APIRequests<Path>>(
  path: Path,
  options?: Options,
