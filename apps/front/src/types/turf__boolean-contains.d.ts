module "@turf/boolean-contains" {
  ...
  export declare function isMultiPointInMultiPoint(
    multiPoint1: MultiPoint,
    multiPoint2: MultiPoint,
  ): boolean;
  export declare function isMultiPointOnLine(
   ...
   * @returns {boolean} true/false
   */
  export declare function isPolyInPoly(
