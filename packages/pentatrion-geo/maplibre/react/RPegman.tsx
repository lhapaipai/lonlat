...
export type PegmanCallbacks = {
  onDragStart?: (e: Event<LLPegman>) => void;
  onDrag?: (e: Event<LLPegman>) => void;
  onDragEnd?: (e: Event<LLPegman>) => void;
...
function RPegman(props: RPegmanProps, ref: Ref<LLPegman>) {
  ...
  useImperativeHandle(ref, () => marker as LLPegman, [marker]);
...
export default memo(forwardRef(RPegman));
